...
static int main_dgemm(const int m, const int n, const int k, const int elements_type, const char* verbose);
...
int main(int argc, char** argv)
{
    ...
    main_dgemm(atoi(argv[1]), atoi(argv[2]), atoi(argv[3]), atoi(argv[4]), argv[5]);
    return EXIT_SUCCESS;
}
